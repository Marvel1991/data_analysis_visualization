...
p15<-p14+ ggtitle("Monthly Distribution of RV-ABC from Sep 2014 to Dec 2016 (n=2277)") +  theme(axis.text=element_text(size=13),axis.title=element_text(size=20,face="bold", vjust=0.5), plot.title = element_text(hjust = 0.5,size = 25,vjust = 2.1))
p15