...
For example, 
* carry out data management on Linux Server, e.g. directives like makdir,cp, mv, rm, less, 
* download and install softwares/algorithms on Server, e.g. FastQC, cutadapt, bowtie, tophat, DESeq et al.
